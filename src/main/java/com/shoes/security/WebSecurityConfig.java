    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth.requestMatchers("/**").permitAll()
                        ...
                        .requestMatchers("/api/v1/customers/home/**").permitAll()
                        .requestMatchers("/api/v1/customers/products/**").permitAll()
                        .requestMatchers("/api/v1/customers/carts/**").hasRole("CUSTOMER")
                        .requestMatchers("/api/v1/customers/orders/**").hasRole("CUSTOMER")
                        .requestMatchers("/api/v1/managers/**").hasRole("MANAGER")
                        .requestMatchers("/api/v1/categories/**").hasRole("MANAGER")
                        .requestMatchers("/api/v1/payments/**").hasRole("MANAGER")
